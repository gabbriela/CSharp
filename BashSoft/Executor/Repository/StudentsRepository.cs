    ...
    public class StudentsRepository : IDatabase
    {
        ...
        public void GetAllStudentsFromCourse(string courseName)
        {
            if (this.IsQueryForCoursePossible(courseName))
            {
                ...
                foreach (var studentMarksEntry in this.Courses[courseName].GetStudentByName())
                {
        ...
        public void OrderAndTake(string courseName, string comparison, int? studentsToTake = null)
        {
            if (this.IsQueryForCoursePossible(courseName))
            {
                ...
                {
                    studentsToTake = this.Courses[courseName].GetStudentByName().Count;
                }

                //Dictionary<string, double> marks = this.Courses[courseName].GetStudentByName()
        ...
        public void GetStudentMarkInCourse()
        {
